...
export const corridorStory: Story = {
  id: "corridor",
  chapterLabel: "世界线 · 01",
  card: {
  ...
  background: bgCorridor,
  backgroundAlt: "凌晨的老公寓楼道，一辆正在充电的电动车渗出烟雾",
  cast: [CHARACTERS.linxia],
  introLines: ["回答中的字忽然开始脱落。", "下一秒，凌晨的冷风吹到了你的脸上。"],
  nodes: [
    {
      speaker: "narrator",
